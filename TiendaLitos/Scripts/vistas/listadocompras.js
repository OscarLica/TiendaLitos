$(function () {
    ...
    $(document).on("click", "button[data-accion-view]", function () {
        ...
        $.each(detalleCompra.detalle, function (i, det) {
            row += "<tr><td>" + det.Articulo + "</td><td>" + det.Color + "</td><td>" + det.Marca + "</td><td>" + det.Medida + "</td><td>" + det.Talla + "</td><td>" + det.Cantidad + "</td><td>C$ " + det.Precio+ "</td><td>% " + det.Descuento + "</td><td>C$ " + det.SubTotalArticulo +"</td></tr>";
        });
